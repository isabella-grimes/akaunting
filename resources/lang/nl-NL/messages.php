...
return [
    ...
    'error' => [
        ...
        'import_column'     => 'Fout: :message Kolomnaam: :column. Regelnummer: :line.',
        'import_sheet'      => 'Fout: Bladnaam is niet geldig. Vergelijk het met het voorbeeldbestand.',
        'same_amount'       => 'Fout: Het totale bedrag van de splitsing moet precies hetzelfde zijn als het :transaction totaal: :amount',
    ...
    'warning' => [
        ...
        'reconciled_doc'    => 'Waarschuwing: U heeft geen toestemming om :type te wijzigen/verwijderen omdat deze afstemmings transacties bevat!',
        'disable_code'      => 'Waarschuwing: U mag <b>:name</b> niet uitschakelen of de valuta wijzigen omdat het gerelateerd is aan :text.',
